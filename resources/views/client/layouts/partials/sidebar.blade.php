        ...
        @if (Auth::user()->isAdmin())
            ...
            <div x-data="{ open: true }">
                <button @click="open = !open"
                    ...
                    <div class="flex items-center">
                        <p class="text-xs font-semibold text-teal-400 uppercase tracking-wider">🏪 Gestión de Comercios
                        </p>
                    </div>
            ...
            <div x-data="{ open: true }">
                <button @click="open = !open"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x-show="open" class="h-4 w-4 text-teal-400"
            ...
            <div x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x-show="!open" class="h-4 w-4 text-gray-400"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" x-show="open" class="h-4 w-4 text-teal-400"
